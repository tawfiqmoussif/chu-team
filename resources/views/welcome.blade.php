...
<div class="super_container">
		...
		<div class="container">
			<div class="row row-eq-height">
				...
				<div class="col-lg-4 info_box_col">
					<div class="info_box">
						<div class="info_image"><img src="/health/images/info_1.jpg" alt=""></div>
				...
				<div class="col-lg-4 info_box_col">
					<div class="info_box">
						<div class="info_image"><img src="/health/images/info_2.jpg" alt=""></div>
						<div class="info_content">
	...
	<div class="cta">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="/health/images/cta_1.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
		...
		<div class="container">
			...
			<div class="row icon_boxes_row">
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="/health/images/icon_1.svg" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="/health/images/icon_2.svg" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="/health/images/icon_3.svg" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="/health/images/icon_4.svg" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="/health/images/icon_5.svg" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="/health/images/icon_6.svg" alt=""></div>
	...
	<footer class="footer">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="/health/images/footer.jpg" data-speed="0.8"></div>
